...
// default superadmin creds used for test 
const dummySuperAdmin = {
  firstName: "dummyAdmin",
  lastName: "dummyAdmin",
  email: "dummyAdmin@voty.tn",
};
...
/**
* Enroll superadmin user on server startup
* @param {string} firstName 
* @param {string} lastName 
* @param {string} email 
*/
async function enrollSuperAdmin(data) {
  ...
  try {
    ...
    console.log(e);
    return ({ error: 'Problem in transaction execution' });
  }
...
app.listen(process.env.PORT || 8081, function () {
  ...
  // enroll superAdmin on startup
  enrollSuperAdmin(dummySuperAdmin)
});
